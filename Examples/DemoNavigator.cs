...
namespace PoolMaster.Examples
{
    ...
    public class DemoNavigator : MonoBehaviour
    {
        ...
        [SerializeField] private List<DemoMetadata> demos = new List<DemoMetadata>();
        ...
        private void SetupDemos()
        {
            ...
            var collectionDemo = FindObjectsByType<CollectionPoolingDemo>(FindObjectsSortMode.None)[0];
            ...
            demos = new List<DemoMetadata>
            {
                new DemoMetadata
                {
                    ...
                    description = "The most common pooling use-case in games: bullets, arrows, and projectiles.",
                    features = "• High-frequency spawning (multiple projectiles/second)\n• Automatic despawn after lifetime\n• Zero garbage collection overhead\n• Perfect for: Shooting games, tower defense, action games",
                ...
                new DemoMetadata
                {
                    ...
                    description = "Reuse visual effects instead of destroying them. Essential for polished games.",
                    features = "• Event-driven spawning (explosions, impacts, collectibles)\n• Scale, fade, and animate effects\n• Reduce instantiation lag spikes\n• Perfect for: Particle systems, UI effects, environment details",
                ...
                new DemoMetadata
                {
                    ...
                    description = "Spawn waves of enemies efficiently. Used in every action/arcade game.",
                    features = "• Batch spawning for waves\n• Circular/grid spawn patterns\n• Dynamic pool expansion\n• Perfect for: Wave spawners, enemy AI, traffic systems",
                ...
                new DemoMetadata
                {
                    ...
                    description = "Spawn dozens/hundreds of particles instantly without frame drops.",
                    features = "• Burst spawning (50+ objects at once)\n• Physics-based motion\n• Dynamic pool sizing\n• Perfect for: Explosions, confetti, debris, shatter effects",
                ...
                new DemoMetadata
                {
                    ...
                    description = "The foundation: simple spawn and despawn cycles for any GameObject.",
                    features = "• Simple API: Get() and Return()\n• Automatic initialization\n• Configurable pool sizes\n• Perfect for: Pickups, platforms, UI elements, generic objects",
                ...
                new DemoMetadata
                {
                    ...
                    description = "Reuse List/Dictionary/HashSet to eliminate ALL garbage collection.",
                    features = "• Pool C# collections, not just GameObjects\n• Zero allocations in hot paths\n• 300+ operations/second with no GC\n• Perfect for: Data processing, pathfinding, queries, temporary buffers",
        ...
        private void CreateUI()
        {
            ...
            // Title (left side, top)
            titleText = CreateText(panelObj.transform, "Title", new Vector2(0, 1), new Vector2(0.4f, 1), new Vector2(0, 1),
                new Vector2(20, -15), new Vector2(-10, -15), 28, FontStyle.Bold, TextAnchor.UpperLeft);

            // Description (left side, middle)
            descriptionText = CreateText(panelObj.transform, "Description", new Vector2(0, 1), new Vector2(0.4f, 1), new Vector2(0, 1),
                new Vector2(20, -55), new Vector2(-10, -55), 14, FontStyle.Normal, TextAnchor.UpperLeft);

            // Features (right side, all)
            featuresText = CreateText(panelObj.transform, "Features", new Vector2(0.4f, 1), new Vector2(1, 1), new Vector2(0, 1),
                new Vector2(10, -15), new Vector2(-150, -15), 13, FontStyle.Normal, TextAnchor.UpperLeft);

            // Navigation buttons (bottom right)
            prevButton = CreateNavButton(panelObj.transform, "◄ PREVIOUS", new Vector2(1, 0), new Vector2(1, 0), 
                new Vector2(-140, 10), new Vector2(130, 45), () => Navigate(-1));

            nextButton = CreateNavButton(panelObj.transform, "NEXT ►", new Vector2(1, 0), new Vector2(1, 0),
                new Vector2(-10, 10), new Vector2(130, 45), () => Navigate(1));

            // Page indicator (bottom right, above buttons)
            pageIndicatorText = CreateText(panelObj.transform, "1 / 7", new Vector2(1, 0), new Vector2(1, 0), new Vector2(1, 0),
                new Vector2(-140, 65), new Vector2(200, 30), 16, FontStyle.Bold, TextAnchor.MiddleRight);
        }

        private Text CreateText(Transform parent, string name, Vector2 anchorMin, Vector2 anchorMax, Vector2 pivot,
            Vector2 offsetMin, Vector2 offsetMax, int fontSize, FontStyle style, TextAnchor alignment)
        {
        ...
        private Button CreateNavButton(Transform parent, string label, Vector2 anchorMin, Vector2 anchorMax, 
            Vector2 position, Vector2 size, System.Action onClick)
        {
        ...
        private void Navigate(int direction)
        {
            ...
            if (newIndex < 0) newIndex = demos.Count - 1;
            if (newIndex >= demos.Count) newIndex = 0;
